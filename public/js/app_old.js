(function() {
  var FizzyText, MARGIN, SCREEN_HEIGHT, SCREEN_WIDTH, animDelta, animDeltaDir, animate, animateTerrain, applyShader, camera, cameraOrtho, clock, container, directionalLight, heightMap, init, lightDir, lightVal, loadTextures, mlib, morph, morphs, normalMap, oldSoundVal, onKeyDown, onWindowResize, pointLight, quadTarget, render, renderer, scene, sceneRenderTarget, soundDir, soundVal, stats, terrain, textMesh1, textureCounter, uniformsNoise, uniformsNormal, updateNoise;
  ...
  init = function() {
    var addMorph, controls, detailTexture, diffuseTexture1, diffuseTexture2, geometryTerrain, i, loader, material, morphColorsToFaceColors, normalShader, params, pars, plane, rx, ry, specularMap, startX, terrainShader, uniformsTerrain, vertexShader;
    ...
    scene.fog = new THREE.Fog(0x0505ff, 2000, 4000);
    scene.add(new THREE.AmbientLight(0x111122));
    directionalLight = new THREE.DirectionalLight(0xeeeeff, 1.15);
    directionalLight.position.set(500, 2000, 0);
    scene.add(directionalLight);
    pointLight = new THREE.PointLight(0xeeeeff, 1.5);
